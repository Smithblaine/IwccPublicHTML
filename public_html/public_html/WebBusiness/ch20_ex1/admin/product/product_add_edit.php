...
<section>
    ...
    <div id="formatting_directions">
        ...
        <ul>
            <li>Press enter twice to start a new paragraph.</li>
            <li>Use an asterisk to mark items in a bulleted list.</li>
            <li>Press enter once between items in a bulleted list.</li>
            <li>Use ^ before the sentence for bold.</li>
            <li>Use ~ before the sentence for italics.</li>
        </ul>
    </div>
</section>
